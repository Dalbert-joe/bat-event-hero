...
import logo from "@/assets/strata26-logo.png";
import batButton from "@/assets/bat-button.png";
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 py-6 md:px-14">
        <img src={logo} alt="STRATA'26" className="h-12 md:h-14 w-auto drop-shadow-[0_0_20px_rgba(220,0,0,0.5)]" />
